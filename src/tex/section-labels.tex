\sectionwithlogo{Надписи}
	{\input{figure-metapost-shadowed}}
...
\centerline{\input{figure-label-suffices}}
\end{frame}
...
\begin{center}
\only<1>{\input{figure-octagon}}%
\only<2>{\input{figure-octagon-label-rt}}%
\only<3>{\input{figure-octagon-label-urt}}%
\only<4>{\input{figure-octagon-label-top}}%
\only<5>{\input{figure-octagon-label-ulft}}%
\only<6>{\input{figure-octagon-label-lft}}%
\only<7>{\input{figure-octagon-label-llft}}%
\only<8>{\input{figure-octagon-label-bot}}%
\only<9>{\input{figure-octagon-label-lrt}}%
\only<10>{\input{figure-octagon-label}}%
\end{center}
