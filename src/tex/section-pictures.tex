...
\column{.5\textwidth}
\centerline{\input{figure-houses}}
\end{columns}
\end{frame}
...
\only<1>{\input{figure-clipping-1}}%
\only<2>{\input{figure-clipping-2}}%
\column{.6\textwidth}
\begin{programlisting}
...
\column{.33333\textwidth}
\centering
\only<1>{\input{figure-texture-1}}%
\only<2>{\input{figure-texture-2}}%
\only<3>{\input{figure-texture-3}}%
\column{.6\textwidth}
\only<1-2>{
