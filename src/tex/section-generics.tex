\sectionwithlogo{Общие сведения}{\input{figure-clock}}
...
\column{.45\textwidth}
\only<1>{\input{figure-clock}}
\only<2>{\input{figure-piechart}}
\only<3>{\input{figure-graph}}
\only<4>{\input{figure-fejer}}
\only<5>{\input{figure-mmflogo}}
