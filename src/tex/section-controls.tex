...
\begin{tabular}{|r|l|}
\hline
$x$\literal{~=~}$y$&$x$ равно $y$\\\hline
$x$\literal{~<>~}$y$&$x$ не равно $y$\\\hline
$x$\literal{~<~}$y$&$x$ меньше $y$\\\hline
$x$\literal{~<=~}$y$&$x$ меньше либо равно $y$\\\hline
$x$\literal{~>~}$y$&$x$ больше $y$\\\hline
$x$\literal{~>=~}$y$&$x$ больше либо равно $y$\\\hline
\literal{not~}$q$&не $q$\\\hline
$p$\literal{~and~}$q$&$p$ и $q$\\\hline
$p$\literal{~or~}$q$&$p$ или $q$\\\hline
\literal{cycle~}$p$&путь $p$ циклический\\\hline
\literal{color~}$v$&значение $v$ имеет тип \literal{color}\\\hline
\end{tabular}
\end{center}
\end{frame}
