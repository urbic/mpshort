\sectionwithlogo{Пример}{\input{figure-example}}
...
\uncover<3->{%
\only<1-3>{This is MetaPost, version 2.01 (TeX Live 2021/TeX Live)\par
(example.mp [1] )\par
1 output file written: example.1\par
Transcript written on example.log.}%
\only<4>{Это MetaPost, версия 2.01 (TeX Live 2021/TeX Live)\par
(example.mp [1] )\par
